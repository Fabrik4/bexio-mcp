  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        user_id: { type: "integer", description: "User ID (creator). Defaults to 1 if neither user_id nor owner_id is set." },
        owner_id: { type: "integer", description: "Owner user ID (Bexio requires this). Defaults to user_id or 1 if not set." },
      },
